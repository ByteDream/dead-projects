...
package org.blueshard.theosUI.theosFX.utils;
...
public class SVGToGenericImage {
    ...
    private ByteArrayOutputStream convert(InputStream inputStream, Transcoder transcoder, float height, float width) throws TranscoderException, IOException {
